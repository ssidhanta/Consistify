...
import com.lsu.test.ClientQueryExampleThreadFixed;
...
public class InterfaceFixed {
	...
	public void insert(String keyspace, String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11, String string12, int index, long l, long latency_insert2, String cLevel, String CLID, long tInv, Session session) {
		...
		statement = setConsistencyLevel(statement, ClientQueryExampleThreadFixed.cLevel);
	...
	public String read(String keyspace, String string, String string2, String string3, int index, long l, long latency_read2, String cLevel, String CLID, long tInv, Session session) {
		// TODO Auto-generated method stub
	...
	public void update(String keyspace, String string, String string2, String string3,
			String string4, String string5, String string6, int index, long l, long latency_update2, String cLevel, String CLID, long tInv, Session session) {
		// TODO Auto-generated method stub
	...
	/*public ResultSet scheduleAndQueue(String operationtype, Statement statement, Session session, int index, long l, long latency_insert2, String cLevel, String clId, long tInv, Tuple tuple)
	{
		...
		else
		{
			...
			statement = updateConsistencyLevel(statement,cLevel,index,tuple);
			//System.out.println("***Executing eventual consistent queries");
			result = session.execute(statement);//unblock for deploy
	...
	public ArrayBlockingQueue<Query> pushQueues(){
		// TODO Auto-generated method stub
		String key = null;
	...
	public Statement updateConsistencyLevel(Statement statement, String cLevel, int index, Tuple  tuple) {
		...
		setConsistencyLevel(statement,cLevel);
		return statement;
	}
	
	public void setConsistencyLevel(Statement statement, String cLevel) {
		// TODO Auto-generated method stub
		if(cLevel.equalsIgnoreCase("ALL"))
			statement.setConsistencyLevel(ConsistencyLevel.ALL);
		else if(cLevel.equalsIgnoreCase("QUORUM"))
	...
	public synchronized Session callInterface(String cLevel, String condn, String className, String CLID, long tInv, int currthreadCount) {
		...
		ArrayBlockingQueue<Query> causalQueue = pushQueues();
		...
		if( ClientQueryExampleThreadFixed.session==null || ClientQueryExampleThreadFixed.session.isClosed())
			ClientQueryExampleThreadFixed.session = ClientQueryExampleThreadFixed.callClient(cLevel, condn);//unblock for deploy
		//tuple.setCausalQueue(causalQueue); 
		//tuple.setSession(ClientQueryExampleThreadFixed.session);
		//System.out.println("***After callClient");
